...
import org.openmrs.module.insuranceclaims.api.impl.InsuranceClaimsServiceImpl;
...
/**
 * This is a unit test, which verifies logic in InsuranceClaimsService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class InsuranceClaimsServiceTest {
	
	@InjectMocks
	InsuranceClaimsServiceImpl basicModuleService;
	
	@Mock
	InsuranceClaimsDao dao;
